const i18n = {
  'en-US': {
    ...
    'menu.homeSite': 'Home Site Settings',
    'menu.headerFooter': 'Header/Footer Settings',
    'menu.right': 'Right Settings',
    'menu.articles': 'Articles Settings',
  ...
  'zh-CN': {
    ...
    'menu.site': '网页配置',
    'menu.homeSite': '首页配置',
    'menu.headerFooter': 'Header/Footer配置',
    'menu.right': '侧栏配置',
    'menu.articles': '文章管理',
